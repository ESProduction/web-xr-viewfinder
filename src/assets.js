...
export default {
  ...
  stereopanoL: { url: 'background_sphere.jpg', options: { encoding: THREE.sRGBEncoding }},
  stereopanoR: { url: 'background_sphere.jpg', options: { encoding: THREE.sRGBEncoding }},
